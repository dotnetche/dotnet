...
export class HotelsService extends CrudService<any> {
  constructor(injector: Injector) { super(injector); }

  override getResourceUrl(): string { return 'Hotel'; }

  getAllOperators() { return this.httpClient.get<any[]>(`${this.APIUrl}/GetAllOperators`); }
  getAllDestinations() { return this.httpClient.get<any[]>(`${this.APIUrl}/GetAllDestinations`); }
