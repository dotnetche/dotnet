...
{
    public class PaymentTypeService : GenericCrudService<PaymentType>, IPaymentTypeService
    {
        public PaymentTypeService(BaseTLTravelDbContext dbContext) : base(dbContext)
        {
        }
